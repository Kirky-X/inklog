...
#[cfg(test)]
use crate::infrastructure::cache::MockCache;
#[cfg(feature = "dbnexus")]
use crate::infrastructure::Database;
use crate::infrastructure::{Cache, ConfersAdapter, Config, OxCacheAdapter};
use crate::manager::{LoggerDependencies, LoggerManager};
...
mod tests {
    use super::*;
    use crate::infrastructure::{ConfersAdapter, OxCacheAdapter};
